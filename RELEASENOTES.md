...
* Security: Harden SVG icon import sanitization (obfuscated javascript href, deep nesting guard, stable `<svg>` serialization) and preserve admin API-key imports. https://github.com/abeggled/openbridgeserver/pull/555
